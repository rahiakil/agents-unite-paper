...
This mirrors statistical sampling: each agent is an enumerator, verifiers are auditors, and consensus is official tabulation. Backtesting and RAG below consume census output; they are downstream uses of the ledger, not additional consensus steps.

\subsection{Downstream Use: Backtesting Methodology}
...
\subsection{Downstream Use: RAG and LLM Queries}
